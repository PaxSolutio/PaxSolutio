    ...
    <section className="relative overflow-hidden bg-[#071B33] pb-24 pt-40 text-white lg:pb-32 lg:pt-48">
      ...
      <div className="mx-auto max-w-[1320px] px-6 lg:px-10">
        <div className="max-w-[900px]">
          ...
          <p className="mt-7 max-w-[760px] text-lg leading-8 text-white/60 lg:text-xl">
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row">
            <Link
              href="/#project"
              className="inline-flex min-h-14 items-center justify-center rounded-xl bg-[#176BFF] px-7 text-sm font-extrabold text-white transition hover:-translate-y-0.5"
            >
            ...
            <Link
              href="/fournisseurs"
              className="inline-flex min-h-14 items-center justify-center rounded-xl border border-white/15 px-7 text-sm font-extrabold"
            >
