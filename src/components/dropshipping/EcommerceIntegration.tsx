      ...
      <div className="mx-auto grid max-w-[1320px] gap-16 px-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:px-10">
        <div>
          ...
          <h2 className="text-[38px] font-extrabold leading-[1.08] tracking-[-0.045em] text-[#071B33] sm:text-[48px] lg:text-[54px]">
            Une infrastructure conçue pour
            <span className="text-[#176BFF]">
              {" "}
              évoluer avec vos commandes.
            </span>
          </h2>

          <p className="mt-6 max-w-[590px] text-base leading-8 text-[#657386]">
            Selon les outils et services disponibles, les flux peuvent évoluer
            vers une organisation plus automatisée entre votre boutique, les
            commandes, le stock, la préparation et les informations
            logistiques.
          </p>
        ...
        <div className="rounded-[32px] border border-[#E1E8F0] bg-[#F7F9FC] p-7 sm:p-9">
          ...
          <div className="mt-7 space-y-3">
            {[
              ["01", "Commande client"],
              ["02", "Commande reçue"],
              ["03", "Traitement logistique"],
              ["04", "Pick & Pack"],
              ["05", "Remise au transporteur"],
              ["06", "Suivi de l'expédition"],
            ].map(([number, label]) => (
              <div
                key={number}
          ...
          <div className="mt-4 rounded-[18px] bg-[#EAF2FF] p-5">
            ...
            <p className="mt-2 text-xs leading-6 text-[#657386]">
              Les intégrations API et automatisations peuvent être étudiées
              selon les plateformes utilisées et les services effectivement
